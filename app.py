...
'No cuento con informacion oficial suficiente en el documento recuperado para responder con precision.'
...
def main() -> None:
    ...
    if st.button("Consultar", type="primary"):
        ...
        if not results:
            st.error("No se encontraron fragmentos en la base vectorial. Ejecuta ingest.py.")
            return
